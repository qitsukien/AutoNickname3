...
## Новая функциональная админ-панель

Команда `/admin_panel` открывает скрытую панель только для администратора. Из неё можно:
- обновить публичную панель регистрации
- запустить system check
- создать backup
- экспортировать CSV
- открыть инструменты для работы с пользователями
- открыть настройки шаблона и переключателей

Во вкладке пользователей доступны действия через кнопки и модальные окна:
- восстановить пользователя
- переименовать
- пересобрать ник
- удалить запись из БД
- посмотреть историю имён
- сделать предпросмотр ника

Во вкладке настроек доступны:
- смена шаблона ника
- включение и выключение self-restore
- включение и выключение смены имени
- ручное обновление публичной панели
