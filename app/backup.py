...
class BackupManager:
    ...
    def should_run_backup(self) -> bool:
        ...
        last_backup = cfg.get("last_auto_backup_at") or cfg.get("last_backup_at")
        if not last_backup:
            return True
        try:
    ...
    def cleanup_old_backups(self) -> None:
        cfg = load_config()
        max_backups = int(cfg.get("backup_max_files", cfg.get("max_backups", 5)) or 5)
