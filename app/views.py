...
class SafeView(discord.ui.View):
    async def on_error(self, interaction: discord.Interaction, error: Exception, item: discord.ui.Item[discord.ui.View]) -> None:
        embed = base_embed("Ошибка", "Не удалось выполнить действие. Проверь права бота и повтори ещё раз.", 0xED4245)
        try:
...
class RegistrationModal(SafeModal, title="Регистрация"):
...
class AdminRefreshButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Обновить панель", style=discord.ButtonStyle.primary, custom_id="admin_refresh_panel")
...
class AdminSystemCheckButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="System Check", style=discord.ButtonStyle.secondary, custom_id="admin_system_check")
...
class AdminBackupButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Сделать backup", style=discord.ButtonStyle.success, custom_id="admin_make_backup")
...
class AdminExportUsersButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Экспорт CSV", style=discord.ButtonStyle.secondary, custom_id="admin_export_csv")
...
class OpenUserToolsButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Пользователи", style=discord.ButtonStyle.primary, custom_id="admin_open_users")
...
class OpenSettingsButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Настройки", style=discord.ButtonStyle.secondary, custom_id="admin_open_settings")
...
class RestoreUserModal(SafeModal, title="Восстановить пользователя"):
...
class RenameUserModal(SafeModal, title="Переименовать пользователя"):
    user_ref = discord.ui.TextInput(label="ID или mention пользователя", placeholder="1481855136622968834")
...
class RefreshNickModal(SafeModal, title="Пересобрать ник"):
    user_ref = discord.ui.TextInput(label="ID или mention пользователя", placeholder="1481855136622968834")
...
class DeleteUserModal(SafeModal, title="Удалить запись из БД"):
    user_ref = discord.ui.TextInput(label="ID или mention пользователя", placeholder="1481855136622968834")
...
class NameHistoryModal(SafeModal, title="История имён"):
    user_ref = discord.ui.TextInput(label="ID или mention пользователя", placeholder="1481855136622968834")
...
class CheckNameModal(SafeModal, title="Предпросмотр ника"):
    user_ref = discord.ui.TextInput(label="ID или mention пользователя", placeholder="1481855136622968834")
...
class OpenModalButton(discord.ui.Button):
    def __init__(self, *, label: str, style: discord.ButtonStyle, modal_factory, custom_id: str):
...
class AdminUserToolsView(SafeView):
    def __init__(self) -> None:
        super().__init__(timeout=None)
        self.add_item(OpenModalButton(label="Восстановить", style=discord.ButtonStyle.success, modal_factory=RestoreUserModal, custom_id="admin_users_restore"))
        self.add_item(OpenModalButton(label="Переименовать", style=discord.ButtonStyle.primary, modal_factory=RenameUserModal, custom_id="admin_users_rename"))
        self.add_item(OpenModalButton(label="Пересобрать ник", style=discord.ButtonStyle.secondary, modal_factory=RefreshNickModal, custom_id="admin_users_refresh"))
        self.add_item(OpenModalButton(label="Удалить из БД", style=discord.ButtonStyle.danger, modal_factory=DeleteUserModal, custom_id="admin_users_delete"))
        self.add_item(OpenModalButton(label="История имён", style=discord.ButtonStyle.secondary, modal_factory=NameHistoryModal, custom_id="admin_users_history"))
        self.add_item(OpenModalButton(label="Предпросмотр", style=discord.ButtonStyle.secondary, modal_factory=CheckNameModal, custom_id="admin_users_preview"))


class SetNickFormatModal(SafeModal, title="Сменить шаблон ника"):
...
class ToggleNameChangeButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Вкл/выкл смену имени", style=discord.ButtonStyle.secondary, custom_id="admin_toggle_name_change")
...
class ToggleRestoreButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Вкл/выкл self-restore", style=discord.ButtonStyle.secondary, custom_id="admin_toggle_self_restore")
...
class OpenSetNickFormatButton(discord.ui.Button):
    def __init__(self) -> None:
        super().__init__(label="Сменить шаблон", style=discord.ButtonStyle.primary, custom_id="admin_open_set_format")
...
class AdminSettingsView(SafeView):
    def __init__(self) -> None:
        super().__init__(timeout=None)
